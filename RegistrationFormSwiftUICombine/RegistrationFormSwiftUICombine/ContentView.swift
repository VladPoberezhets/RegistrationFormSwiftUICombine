                ...
                VStack{
                    ...
                    VStack(alignment:.leading){
                        Text("Password")
                            .font(.subheadline)
                            .foregroundColor(Color.green)
                        TextField("Enter your password", text: self.$password).frame(height:self.heightTextFiled)
                        Divider()
                        Text("Error").font(.footnote).foregroundColor(Color.red).padding(.leading,geometry.size.width/self.errorPadding)
                    }.padding([.leading,.trailing])
                    ...
                    VStack(alignment:.leading){
                        Text("Confirm password")
                            .font(.subheadline)
                            .foregroundColor(Color.green)
                        TextField("Confirm your password", text: self.$confirmPassword).frame(height:self.heightTextFiled)
                        Divider()
                        Text("Error").font(.footnote).foregroundColor(Color.red).padding(.leading,geometry.size.width/self.errorPadding)
                    }.padding([.leading,.trailing])
